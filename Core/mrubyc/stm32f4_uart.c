...
UART_HANDLE * const TBL_UART_HANDLE[] = {&uh1, &uh2, 0, 0, 0, &uh6};
...
void uart_init(void)
{
  ...
  */
  ...
  HAL_UART_Receive_DMA(uh1.hal_uart, uh1.rxfifo, UART_SIZE_RXFIFO);
  ...
  */
  ...
  HAL_UART_Receive_DMA(uh2.hal_uart, uh2.rxfifo, UART_SIZE_RXFIFO);
  ...
  */
  ...
  HAL_UART_Receive_DMA(uh6.hal_uart, uh6.rxfifo, UART_SIZE_RXFIFO);
}
...
static void c_uart_new(mrbc_vm *vm, mrbc_value v[], int argc)
{
  ...
  *(UART_HANDLE**)(v[0].instance->data) = TBL_UART_HANDLE[unit_num-1];
